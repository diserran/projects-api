...
use Webkul\ManagementPlan\Providers\ManagementPlanServiceProvider;
...
use Webkul\TimeTracker\Providers\TimeTrackerServiceProvider;
...
return [
    ...
    TimeTrackerServiceProvider::class,
    ManagementPlanServiceProvider::class,
];
